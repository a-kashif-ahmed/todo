      ...
      <div className="flex flex-col gap-3">
        <div>
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            We detected a change that may impact CRM Sync. Structural changes
            in the source webhook schema were identified 15 minutes ago.
          </p>
        </div>

        {/* Button */}
        <button className="self-start text-sm font-medium bg-[#DDB7FF33] hover:bg-[#DDB7FF4D] text-[#DDB7FF] border border-[#DDB7FF44] rounded-lg px-4 py-1.5 transition-colors">
          Analyze Impact →
        </button>
      </div>
