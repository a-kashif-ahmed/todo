...
export default function SupportPanel() {
  return (
    <div className="max-w-lg space-y-4">
      <div>
        <h1 className="text-xl font-semibold text-white mb-1">Support</h1>
        <p className="text-sm text-gray-500">Get help with FlowLens.</p>
      </div>
      ...
      <div className="space-y-2">
        {links.map(link => (
          ...
          >
            <div className="w-9 h-9 rounded-lg bg-surface border border-border flex items-center justify-center text-gray-400 flex-shrink-0">
              {link.icon}
            </div>
